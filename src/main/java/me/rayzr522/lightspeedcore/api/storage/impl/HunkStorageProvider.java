package me.rayzr522.lightspeedcore.api.storage.impl;

import me.rayzr522.lightspeedcore.LightspeedCore;
import me.rayzr522.lightspeedcore.api.storage.Hunk;
...
public class HunkStorageProvider implements IStorageProvider {
    ...
    @Override
    public void load(LightspeedCore plugin) {
        // NOT NEEDED
    }
    ...
    @Override
    public void unload(LightspeedCore plugin) {
        hunk = null;
        key = null;
        parent = null;
    }
